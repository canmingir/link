...
type PaletteColorName = (typeof PALETTE_COLORS)[number];

const COLORS = ["default", ...PALETTE_COLORS] as const;

const colorByName = (name: string): PaletteColorName | "default" => {
    ...
    MuiAvatarGroup: {
      styleOverrides: {
        root: ({
          ...
          ownerState: Omit<AvatarGroupProps, "variant"> & {
            variant?: "compact";
          };
        }) => ({
