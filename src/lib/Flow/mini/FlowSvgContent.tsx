...
import type { MiniEdge, MiniLayout, MiniNode } from "./layoutFlow";
...
export interface MiniSvgNode extends MiniNode {
  type?: string;
  properties?: { label?: string; action?: string; icon?: string };
  [key: string]: unknown;
}

interface FlowSvgContentProps {
  nodes: MiniSvgNode[];
  ...
  onViewportMouseDown?: (e: ReactMouseEvent<SVGRectElement>) => void;
  isDragging?: boolean;
  type?: string;
  variant?: string;
