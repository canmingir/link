...
})<{ $style?: Record<string, unknown> }>(({ theme, $style = {} }) => {
  const {
    minWidth = 280,
    minHeight = 220,
    maxWidth = 320,
...
const getIcon = (node: InfoNodeData): string => {
...
const InfoNode = ({ node, nodeStyle = {}, children }: InfoNodeProps) => {
