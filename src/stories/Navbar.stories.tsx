...
/** Storybook passes controls in as `args`; each nav-section variant needs at
 * least `data`, so the render callbacks widen through this. */
type NavStoryArgs = ComponentProps<typeof NavSectionVertical>;
